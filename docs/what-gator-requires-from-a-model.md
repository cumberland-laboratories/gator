...
This document explains the minimum behavioral assumptions behind Gator, why some models benefit more than others, and why short structured instructions outperform one giant prompt file.
