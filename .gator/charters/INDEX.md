...
| `extract-claude-sessions.py`, `extract-codex-sessions.py`, `extract-gemini-sessions.py`, `gator-sessions.py`, `gator-session-sink.py`, `gator-session-aggregator.py`, `gator-session-block.py`, `gator_session_reader.py` | [Session Archaeology](scripts-session-archaeology.md) · [Cross-Cutting](scripts-cross-cutting.md) |
