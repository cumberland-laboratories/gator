...
| `extract-codex-sessions.py`, `extract-gemini-sessions.py`, `gator-session-aggregator.py`, `gator-session-common.py`, `gator_session_reader.py` | [Session Archaeology](scripts-session-archaeology.md) · [Cross-Cutting](scripts-cross-cutting.md) |
