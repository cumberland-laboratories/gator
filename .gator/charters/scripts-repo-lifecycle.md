...
! Regression pins: `tests/test_gator_hook.py` (32 — every mode × availability combination + TestResolveRepoRoot + TestResolveRepoRootAdditionalGuards) + `tests/test_hooks.py::TestPinAwareWrappers` (6).
